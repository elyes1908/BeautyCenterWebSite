...
<tr>
<td>Image</td>
<td><input type="text" name="image" value="<?PHP echo $image ?>" id="image" style="border-radius: 12px" required></td>
...
//            var typeValid = /^[A-Za-zéèîïÉÈÎÏ][A-Zéèêàçîï]+([-'\s][A-Za-zéèîïÉÈÎÏ][A-Zéèêàçîï]+)?$/;
//            
...
//            var imageValid = /^[A-Za-zéèîïÉÈÎÏ][A-Zéèêàçîï]+([-'\s][A-Za-zéèîïÉÈÎÏ][A-Zéèêàçîï]+)?$/;
//            
...
//                //Si le format de données est incorrect
//                }else if (imageValid.test(image.value) == false){
//                    event.preventDefault();
//                    missimage.textContent = 'Format incorrect';
//                    missimage.style.color = 'orange';
//                }
//            }
//		var formValid = document.getElementById('bouton');
